...
# Environment variables for PHP dependencies
ENV PHPIZE_DEPS \
    autoconf \
    dpkg-dev dpkg \
    file \
...
RUN apk --no-cache add bind-tools \
    php php-fpm php-opcache php-mysqli php-json php-openssl php-curl \
    php-zlib php-xml php-phar php-intl php-dom php-xmlreader php-ctype \
    php-session php-mbstring php-gd php-tokenizer nginx supervisor curl \
    $PHPIZE_DEPS && \
